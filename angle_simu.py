...
x = unit_trans_scaler*np.array([0.5,0.5,0.57314136,0.14190477,0.6,0.17250387])  # 利用全部数据并采用4层神经网络的结果
# x = unit_trans_scaler*np.array([0, 0, 0, 0, 0, 0])
# 搜索范围与步长
T7_range = unit_trans_scaler*np.arange(-1.2, 1.2, 0.005)  #
T8_range = unit_trans_scaler*np.arange(-1.2, 1.2, 0.005)  # 可调整上限
# 初始化记录矩阵
